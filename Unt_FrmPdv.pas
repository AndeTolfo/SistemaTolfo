...
begin
  ...
  begin
    ...
    _PesquisaCond.Caption := 'Pesquisa por Condições de Pagamento';
...
begin
  ...
  try
     ...
     _Pesquisa.Caption := 'Pesquisa por Condições';
     if _Pesquisa.ShowModal = mrOk then
     begin
       if _Pesquisa.Cod_Selected <> 0 then
       begin
...
var
  ...
  Confirm: Integer;
begin
  // Obtenha o índice da linha selecionada na grade
