...
uses
  ...
  Vcl.Buttons, Vcl.Menus, ppDB, ppDBPipe, ppComm, ppRelatv, ppProd, ppClass,
...
procedure TFrmRelVendas.Listagem1Click(Sender: TObject);
begin
   ImprimirRelatorio(ppRel,'Rel_ListagemVendas.rtm')
end;
